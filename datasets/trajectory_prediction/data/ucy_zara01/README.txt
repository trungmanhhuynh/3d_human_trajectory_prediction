...
crowds_zara01.vsp  			The file given by crowds dataset (https://graphics.cs.ucy.ac.cy/research/downloads/crowd-data)
(pixels)     				Control points (where target turns) of each target


original_data_pixels			Extracted data from ni_examples.vsp
(pixels)				Results by running XXX with input is crowds_zara01.vsp
					Format [frame_number pedestrian_ID pos_x pos_y]


interpolated_data_pixels		Interpolate data from original_data_pixels for each frame
