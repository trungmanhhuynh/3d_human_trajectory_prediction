...
-------------------------------------------------
INFO:
The annotation was done at 2.5 fps, that is with a timestep of 0.4 seconds. (every 10 frames). It actually every 6 frames.
INFO: Video frame rate: 25fps (1 frame = 0.04s). 
INFO: Frame width = 640, frame height = 480
---------------------------------------------------------------------
Important files: 
