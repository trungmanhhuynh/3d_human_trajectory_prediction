...
class Model_LSTM_Scene_nonlinear_subgrids(nn.Module):
    def __init__(self, data_loader, args, train = False):
        super(Model_LSTM_Scene_nonlinear_subgrids, self).__init__()
    ...
    def forward(self, xoff, xabs):
        ...
        final_lstm_output = i_lstm_output + filtered_scene_lstm
